...
public class Current
{
    ...
    public Current(int last_updated_epoch, String last_updated, double temp_c, double temp_f, int is_day, Condition condition, double wind_mph, double wind_kph, int wind_degree, String wind_dir, int pressure_mb, double pressure_in, int precip_mm, int precip_in, int humidity, int cloud, int feelslike_c, int feelslike_f, int windchill_c, double windchill_f, double heatindex_c, double heatindex_f, double dewpoint_c, double dewpoint_f, int vis_km, int vis_miles, int uv, double gust_mph, double gust_kph, int short_rad, int diff_rad, int dni, int gti) {
    ...
    public void setWindchill_c(int windchill_c) {
        this.windchill_c = windchill_c;
    }
